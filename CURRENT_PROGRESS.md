...
- Phase 6 now includes a modality-specific Computed Radiography Image Storage RLE Lossless expansion case, `classic/cr/overlay_modality_voi_rle_lossless`.
- The new case is default-build, byte-stable, generated through the native RLE encoder with one encapsulated fragment, preserves classic CR overlay, Modality LUT, and VOI LUT semantics, validates exact decoded native frame hashes, and appears in JSON reports with RLE codec metadata and compressed CR stressors.
