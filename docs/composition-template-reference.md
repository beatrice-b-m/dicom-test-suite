...
| `derived/parametric-map/float32`@1.0.0 | Parametric Map | `1.2.840.10008.5.1.4.1.1.30` | `1.2.840.10008.1.2.1` (default) | byte_stable | dicom_validator, highdicom-pydicom |
| `derived/parametric-map/float64`@1.0.0 | Parametric Map | `1.2.840.10008.5.1.4.1.1.30` | `1.2.840.10008.1.2.1` (default) | byte_stable | dicom_validator, highdicom-pydicom |
...
| `derived/real-world-value-mapping/linear`@1.0.0 | Real World Value Mapping | `1.2.840.10008.5.1.4.1.1.67` | `1.2.840.10008.1.2.1` (default) | byte_stable | dicom_validator, pydicom-rwvm |
...
| `derived/segmentation/binary`@1.0.0 | Segmentation | `1.2.840.10008.5.1.4.1.1.66.4` | `1.2.840.10008.1.2.1` (default) | byte_stable | dicom_validator, pydicom-segmentation-payload |
