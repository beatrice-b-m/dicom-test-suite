...
pub const ENGINE_RESOURCE_TOTAL_BYTES_V2: u64 = 1_528_469;
pub const ENGINE_RESOURCE_SHA256_V2: &str =
    "86ce3e22a4b9a0a6481238e0add473eb6cb3ebc3d09a67c3db587ecc0a118fc9";
...
mod snapshot_cache_tests {
    ...
    fn snapshot_cache_is_lazy_and_reuses_one_complete_copy_across_clones() {
        ...
        assert_eq!(file_inventory(first.root()), (261, 2_941_727));
        eprintln!(
            "current_snapshot operations=3 roots=1 files_written=261 bytes_written=2941727 elapsed_us={}",
            elapsed.as_micros()
        );
    }
    ...
    fn failed_or_corrupt_materialization_is_not_published_and_can_retry() {
        ...
        let snapshot = resources.shared_snapshot().unwrap();
        assert_eq!(file_inventory(snapshot.root()), (261, 2_941_727));
    }
    ...
    fn one_handle_reuses_one_tree_across_batch_generate_validate_report_and_compose() {
        ...
        assert_eq!(file_inventory(&shared_root), (261, 2_941_727));
