...
pub const ENGINE_RESOURCE_TOTAL_BYTES_V2: u64 = 1_529_925;
pub const ENGINE_RESOURCE_SHA256_V2: &str =
    "adc5767d2ddc28d3f0b66abe6445eaa04157859a60222624b21b4ea9ee98d862";
...
mod snapshot_cache_tests {
    ...
    fn snapshot_cache_is_lazy_and_reuses_one_complete_copy_across_clones() {
        ...
        assert_eq!(file_inventory(first.root()), (261, 2_943_183));
        eprintln!(
            "current_snapshot operations=3 roots=1 files_written=261 bytes_written=2943183 elapsed_us={}",
            elapsed.as_micros()
        );
    }
    ...
    fn failed_or_corrupt_materialization_is_not_published_and_can_retry() {
        ...
        let snapshot = resources.shared_snapshot().unwrap();
        assert_eq!(file_inventory(snapshot.root()), (261, 2_943_183));
    }
    ...
    fn one_handle_reuses_one_tree_across_batch_generate_validate_report_and_compose() {
        ...
        assert_eq!(file_inventory(&shared_root), (261, 2_943_183));
