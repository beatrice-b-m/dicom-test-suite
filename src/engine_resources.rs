...
pub const ENGINE_RESOURCE_TOTAL_BYTES_V2: u64 = 1_524_675;
pub const ENGINE_RESOURCE_SHA256_V2: &str =
    "648a9b004f6c09715860e45ae2f7397b48189cd68fe67a09ac32233a5d5bf82c";
...
mod snapshot_cache_tests {
    ...
    fn snapshot_cache_is_lazy_and_reuses_one_complete_copy_across_clones() {
        ...
        assert_eq!(file_inventory(first.root()), (261, 2_937_933));
        eprintln!(
            "current_snapshot operations=3 roots=1 files_written=261 bytes_written=2937933 elapsed_us={}",
            elapsed.as_micros()
        );
    }
    ...
    fn failed_or_corrupt_materialization_is_not_published_and_can_retry() {
        ...
        let snapshot = resources.shared_snapshot().unwrap();
        assert_eq!(file_inventory(snapshot.root()), (261, 2_937_933));
    }
    ...
    fn one_handle_reuses_one_tree_across_batch_generate_validate_report_and_compose() {
        ...
        assert_eq!(file_inventory(&shared_root), (261, 2_937_933));
