...
mod non_rust_cli_consumer;
#[path = "../qualified_catalog_consumer.rs"]
mod qualified_catalog_consumer;
#[path = "../release_archive.rs"]
mod release_archive;
#[path = "../release_process.rs"]
mod release_process;
#[path = "../sdk_external_consumer.rs"]
