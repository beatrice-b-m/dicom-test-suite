...
fn list_cases_command_shows_core_case_status_and_evidence() {
    ...
    assert!(
        stdout.contains(
            "vl/photo/palette_color_explicit_le\timplemented\tcore\t1.2.840.10008.5.1.4.1.1.77.1.4\t1.2.840.10008.1.2.1\t13/13 covered"
        ),
        "list-cases must include implemented VL Photographic PALETTE COLOR core cases with standards evidence"
    );
    assert!(
        stdout.contains(
...
fn list_cases_command_shows_rle_lossless_as_implemented() {
    ...
    assert!(
        stdout.contains(
            "classic/sc/mono1_u16_odd_3x3_rle_lossless\timplemented\textended\t1.2.840.10008.5.1.4.1.1.7\t1.2.840.10008.1.2.5\t6/6 covered"
        ),
        "MONOCHROME1 unsigned odd 3x3 RLE Lossless row must be listed as implemented"
    );
    assert!(
        stdout.contains(
            "classic/sc/mono2_i16_odd_3x3_rle_lossless\timplemented\textended\t1.2.840.10008.5.1.4.1.1.7\t1.2.840.10008.1.2.5\t6/6 covered"
        ),
        "signed odd 3x3 RLE Lossless row must be listed as implemented"
    );
    assert!(
        stdout.contains(
    ...
    assert!(
        stdout.contains(
            "classic/sc/mono1_u16_rect_2x3_rle_lossless\timplemented\textended\t1.2.840.10008.5.1.4.1.1.7\t1.2.840.10008.1.2.5\t6/6 covered"
        ),
        "MONOCHROME1 rectangular 2x3 RLE Lossless row must be listed as implemented"
    );
    assert!(
        stdout.contains(
            "classic/sc/mono2_i16_rect_2x3_rle_lossless\timplemented\textended\t1.2.840.10008.5.1.4.1.1.7\t1.2.840.10008.1.2.5\t7/7 covered"
        ),
        "signed rectangular 2x3 RLE Lossless row must be listed as implemented"
    );
    assert!(
        stdout.contains(
        ...
        "MONOCHROME1 signed rectangular 2x3 RLE Lossless row must be listed as implemented"
    );
    assert!(
        stdout.contains(
    ...
    assert!(
        stdout.contains(
            "classic/sc/mono1_u16_tiny_1x1_rle_lossless\timplemented\textended\t1.2.840.10008.5.1.4.1.1.7\t1.2.840.10008.1.2.5\t7/7 covered"
        ),
        "MONOCHROME1 tiny 1x1 RLE Lossless row must be listed as implemented"
    );
    assert!(
        stdout.contains(
            "classic/sc/mono2_i16_tiny_1x1_rle_lossless\timplemented\textended\t1.2.840.10008.5.1.4.1.1.7\t1.2.840.10008.1.2.5\t7/7 covered"
        ),
        "signed tiny 1x1 RLE Lossless row must be listed as implemented"
    );
    assert!(
        stdout.contains(
            "classic/sc/mono1_i16_tiny_1x1_rle_lossless\timplemented\textended\t1.2.840.10008.5.1.4.1.1.7\t1.2.840.10008.1.2.5\t7/7 covered"
        ),
        "MONOCHROME1 signed tiny 1x1 RLE Lossless row must be listed as implemented"
    );
    assert!(
        stdout.contains(
    ...
    assert!(
        ...
        "8-bit Pixel Padding RLE Lossless row must be listed as implemented"
    );
    assert!(
        stdout.contains(
            "classic/sc/mono1_u8_padding_rle_lossless\timplemented\textended\t1.2.840.10008.5.1.4.1.1.7\t1.2.840.10008.1.2.5\t9/9 covered"
        ),
        "MONOCHROME1 8-bit Pixel Padding RLE Lossless row must be listed as implemented"
    );
    assert!(
        stdout.contains(
            "classic/sc/mono2_u8_padding_multiframe_rle_lossless\timplemented\textended\t1.2.840.10008.5.1.4.1.1.7\t1.2.840.10008.1.2.5\t9/9 covered"
        ),
        "8-bit multi-frame Pixel Padding RLE Lossless row must be listed as implemented"
    );
    assert!(
        stdout.contains(
            "classic/sc/mono1_u8_padding_multiframe_rle_lossless\timplemented\textended\t1.2.840.10008.5.1.4.1.1.7\t1.2.840.10008.1.2.5\t10/10 covered"
        ),
        "MONOCHROME1 8-bit multi-frame Pixel Padding RLE Lossless row must be listed as implemented"
    );
    assert!(
        stdout.contains(
    ...
    assert!(
        ...
        "MONOCHROME1 unsigned multi-frame Pixel Padding RLE Lossless row must be listed as implemented"
    );
    assert!(
        stdout.contains(
            "classic/sc/mono2_i16_padding_rle_lossless\timplemented\textended\t1.2.840.10008.5.1.4.1.1.7\t1.2.840.10008.1.2.5\t9/9 covered"
        ),
        "signed Pixel Padding RLE Lossless row must be listed as implemented"
    );
    assert!(
        stdout.contains(
        ...
        "MONOCHROME1 signed Pixel Padding RLE Lossless row must be listed as implemented"
    );
    assert!(
        stdout.contains(
            "classic/sc/mono1_i16_padding_multiframe_rle_lossless\timplemented\textended\t1.2.840.10008.5.1.4.1.1.7\t1.2.840.10008.1.2.5\t11/11 covered"
        ),
        "MONOCHROME1 signed multi-frame Pixel Padding RLE Lossless row must be listed as implemented"
    );
    assert!(
        stdout.contains(
        ...
        "signed multi-frame Pixel Padding RLE Lossless row must be listed as implemented"
    );
    assert!(
        stdout.contains(
    ...
    assert!(
        ...
        "signed 16-bit MONOCHROME1 RLE Lossless row must be listed as implemented"
    );
    assert!(
        stdout.contains(
    ...
    assert!(
        ...
        "YBR_FULL planar-1 multi-frame RLE Lossless row must be listed as implemented"
    );
    assert!(
        stdout.contains(
    ...
    assert!(
        ...
        "PALETTE COLOR multi-frame RLE Lossless row must be listed as implemented"
    );
    assert!(
        stdout.contains(
            "classic/sc/mono2_u8_multiframe_rle_lossless\timplemented\textended\t1.2.840.10008.5.1.4.1.1.7\t1.2.840.10008.1.2.5\t5/5 covered"
        ),
    ...
    assert!(
        stdout.contains(
            "classic/sc/mono1_u16_multiframe_rle_lossless\timplemented\textended\t1.2.840.10008.5.1.4.1.1.7\t1.2.840.10008.1.2.5\t6/6 covered"
        ),
        "16-bit MONOCHROME1 multi-frame RLE Lossless row must be listed as implemented"
    );
    assert!(
        stdout.contains(
            "classic/sc/mono2_i16_multiframe_rle_lossless\timplemented\textended\t1.2.840.10008.5.1.4.1.1.7\t1.2.840.10008.1.2.5\t6/6 covered"
        ),
        "signed 16-bit multi-frame RLE Lossless row must be listed as implemented"
    );
    assert!(
        stdout.contains(
        ...
        "signed 16-bit MONOCHROME1 multi-frame RLE Lossless row must be listed as implemented"
    );
    assert!(
        stdout.contains(
    ...
    assert!(
        stdout.contains(
            "classic/sc/mono1_u8_odd_fragment_rle_lossless\timplemented\textended\t1.2.840.10008.5.1.4.1.1.7\t1.2.840.10008.1.2.5\t5/5 covered"
        ),
        "MONOCHROME1 odd-fragment RLE Lossless row must be listed as implemented"
    );
    assert!(
        stdout.contains(
    ...
    assert!(
        ...
        "VL Photographic PALETTE COLOR RLE Lossless row must be listed as implemented"
    );
    assert!(
        stdout.contains(
